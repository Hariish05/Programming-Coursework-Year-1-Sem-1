...
# initialise the three text files to store data
...
def adding_new_course(course_ID, course_name, available_seats):
    ''' Function: To allow new courses to be added with their course ID, course name and total available seats for the course'''
...
def course_enrollment(student_ID, course_ID):
    '''FUNCTION: To allow student to enroll in a course using their student ID and the course ID they want to enroll in. Also notes down date of enrollment'''
...
while True:
    ...
    match userInput:
        case 1: # Adds new student

            # To prevent the user from inputting the wrong student id format
            while True:
                try:
                    student_ID = int(input("Please enter your student ID (e.g. 23132426): ")) # converted to int later or else the try-catch statement wouldnt work
            ...
            adding_new_student(student_ID, student_name,student_contact)    # calls adding_new_student function
        ...
        case 2: # To make a new course
            ...
            adding_new_course(course_ID, course_name, available_seats)      # calls adding_new_course function
        ...
        case 3: # Enroll a student in a course
            ...
            course_enrollment(student_ID, course_ID)   # Calls course_enrollment function            
            while True:
                try:
        ...
        case 4: # Drop a course
            ...
            course_drop(student_ID,course_ID)       # Calls course_drop function
